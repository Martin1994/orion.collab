...
define("orion/editor/editor", [ //$NON-NLS-0$
	...
	objects.mixin(Editor.prototype, /** @lends orion.editor.Editor.prototype */ {
		...
		*/
		...
		/**
		 * Highlight a line then scroll to it.
		 * @param {number} line
		 */
		focusLine: function(line) {
			...
			var type = AT.ANNOTATION_FOCUSED_LINE;
			...
			// Select and scroll to this line
			this.moveSelection(lineStart, lineEnd);
		},

		/**
		 * Unhightlight the focused line
		 */
			...
			if (this._annotationFactory) {
				...
				if (this._annotationModel) {
					...
					if (styler) {
						...
						styler.addAnnotationType(AT.ANNOTATION_FOCUSED_LINE);
