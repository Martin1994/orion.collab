...
define([
    ...
    DebugPane.prototype._createDomNode = function() {
        ...
        buttons.appendChild(this._createDebugCommandButton('debugContinue', messages['Continue'], true));
        buttons.appendChild(this._createDebugCommandButton('debugPause', messages['Pause'], true));
        buttons.appendChild(this._createDebugCommandButton('debugStepOver', messages['StepOver'], true));
        buttons.appendChild(this._createDebugCommandButton('debugStepIn', messages['StepIn'], true));
        buttons.appendChild(this._createDebugCommandButton('debugStepOut', messages['StepOut'], true));
        ...
        // Clear button
        var outputClearButton = this._createDebugCommandButton('debugClearOutput', messages['Clear'], false);
        ...
        // Add button
        var watchAddButton = this._createDebugCommandButton('debugAddWatch', messages['Add'], false);
