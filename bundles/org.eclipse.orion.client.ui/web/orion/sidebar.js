...
define(['orion/objects', 'orion/commands', 'orion/outliner', 'orion/webui/littlelib',
	...
	objects.mixin(Sidebar.prototype, /** @lends orion.sidebar.Sidebar.prototype */ {
		...
		_createDebugPane: function() {
			...
			this.commandRegistry.registerCommandContribution(this.toolsScope, "orion.showDebug", 2, "orion.menuBarToolsGroup", false, new KeyBinding.KeyBinding('d', true, false, true));  //$NON-NLS-1$ //$NON-NLS-0$
		}
	});
