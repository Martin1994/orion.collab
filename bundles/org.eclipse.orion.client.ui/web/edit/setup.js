			...
			this.editor.addEventListener("AnnotationModified", this.editorAnnotationModifiedListener = function(e) {
				...
				e.added.forEach(function(annotation) {
					...
					if (breakpoint instanceof mBreakpoint.LineConditionalBreakpoint) {
						this.commandRegistry.prompt(this.domNode, "Please enter a condition:", "Confirm", "Cancel", "true", false, function(condition) {
							if (condition) {
...
objects.mixin(EditorSetup.prototype, {
	...
	initializeServices: function() {
		...
		this.nativeDeployService = new mNativeDeployService.NativeDeployService(serviceRegistry);
