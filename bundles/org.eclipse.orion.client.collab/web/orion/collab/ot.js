...
define([], function() {
  ...
  ot.OrionAdapter = (function (global) {
    'use strict';
    ...
    // Singular form for backwards compatibility.
    OrionAdapter.operationFromOrionChange =
    ...
    OrionAdapter.prototype.registerCallbacks = function (cb) {
      this.callbacks = cb;
    };
    ...
    OrionAdapter.prototype.onCursorActivity =
    OrionAdapter.prototype.onFocus = function () {
      if (this.changeInProgress) {
        this.selectionChanged = true;
      } else {
        this.trigger('selectionChange');
  ...
  ot.normalSocketAdapter = (function () {
    'use strict';

    function normalSocketAdapter (socket) {
      this.socket = socket;
    ...
    normalSocketAdapter.prototype.sendOperation = function (revision, operation, selection) {
      var msg = {
        'type': 'operation',
        'revision': revision,
        'operation': operation,
    ...
    normalSocketAdapter.prototype.sendSelection = function (selection) {
        var msg = {
        'type': 'selection',
        'selection': selection
      };
    ...
    normalSocketAdapter.prototype.registerCallbacks = function (cb) {
      this.callbacks = cb;
    };

    normalSocketAdapter.prototype.trigger = function (event) {
      var args = Array.prototype.slice.call(arguments, 1);
      var action = this.callbacks && this.callbacks[event];
      if (action) { action.apply(this, args); }
    };

    return normalSocketAdapter;
